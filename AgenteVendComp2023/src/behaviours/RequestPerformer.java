    ...
    case 3:      
      ...
      if (reply != null) {
         if (reply.getPerformative() == ACLMessage.INFORM) {
            ...
            JOptionPane.showConfirmDialog(null,"Se compro el libro \""+ bookTitle+"\" exitosamente.\n\nAgente vendedor: "+reply.getSender().getName()+"\nPrecio: $"+bestPrice, "Compra Exitosa", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE);
            myAgent.doDelete();
         }
         else {
